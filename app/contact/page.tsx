        ...
        <MaxWidthWrapper>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
            ...
            <div>
                  ...
                  <div>
                    ...
                    <div className='flex space-x-4 mt-2'>
                      ...
                      <a
                        ...
                        target='_blank'
                        rel='noopener noreferrer'
                        className='h-8 w-8 rounded-full bg-blue-700 flex items-center justify-center text-white'
                        aria-label='LinkedIn'
                      >
                        <svg
                          className='h-4 w-4'
                      ...
                      <a
                        ...
                        target='_blank'
                        rel='noopener noreferrer'
                        className='h-8 w-8 rounded-full bg-gray-800 dark:bg-gray-700 flex items-center justify-center text-white'
                        aria-label='GitHub'
                      >
                        <svg
                          className='h-4 w-4'
              ...
              <div className='mt-12 bg-blue-50 dark:bg-gray-800 p-6 rounded-lg'>
